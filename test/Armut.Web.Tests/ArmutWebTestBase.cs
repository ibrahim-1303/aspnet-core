...
{
    public abstract class ArmutWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ArmutWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ArmutWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ArmutDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ArmutDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ArmutDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ArmutDbContext, Task<T>> func)
        {
            T result;
